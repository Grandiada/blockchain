...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface MyTokenProxyInterface extends Interface {
  ...
  export interface MyTokenProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): MyTokenProxy;
    waitForDeployment(): Promise<this>;

    interface: MyTokenProxyInterface;
